...
export default class PostingList extends React.Component {
  ...
  render() {
    <div style={{backgroundColor: '#FBF5F3', width: '100px', height: '100px'}}></div>
      ...
      return (
        ...
        <div className="posts">
          ...
          {posts.map(post => (
            ...
            <Post key={post.id} author = {post.authorID} blockedUsers={this.props.blockedUsers} parentID = {post.parentID} post={post} friendIDs={this.props.friendIDs} location={post.attributes.location} tag={post.attributes.tag} type={this.props.type} loadPosts={this.loadPosts}/>
